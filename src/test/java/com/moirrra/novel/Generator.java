...
public class Generator {
    ...
    private static final String BASE_PACKAGE = "com.moirrra.novel";
    ...
    private static final String DATEBASE_URL = "jdbc:mysql://" + DATABASE_IP + ":" + DATABASE_PORT + "/" + DATABASE_NAME + "?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai";
    ...
    private static void genCode(String tables) {
        // 全局配置
        // FastAutoGenerator.create(DATEBASE_URL, DATABASE_USERNAME, DATABASE_PASSWORD)
        FastAutoGenerator.create(DATEBASE_URL, DATABASE_USERNAME, DATABASE_PASSWORD)
